...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task4()
        {
            var res = Emps.Where(c => c.Salary == (Emps.Max(c => c.Salary)));
        }
        ...
        public void Task7()
        {
            var res = Emps.Select(emp => new { EmployeeJob = emp.Job })
            .GroupBy(emp => emp.EmployeeJob)
            .Count();
        ...
        public void Task10()
        {
            //var res2 = (from emp in Emps
              //          select new
            //            { emp.Ename, emp.Job, emp.HireDate })
          //  .Union("No value", null, null);
          var res = Emps.Select(emp =>
                new{ Ename = emp.Ename, Job = emp.Job, Hiredate = emp.HireDate.ToString()})
                .Union(Emps.Select(emp =>
                new{ Ename = "Brak wartości", Job = "null", Hiredate = "null"}));
        ...
        public void Task11()
        {
         //   var res = Emps.Aggregate((emp1, emp2)
        ...
        public void Task12()
        {
            var res = Emps.SelectMany(emp => Depts, (emp1, emp2)
                 => new { emp1, emp2 });
        }
    }
}
